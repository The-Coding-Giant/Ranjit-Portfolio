...
const Footer = () => {
  return (
    <footer className="border-t border-[#2f2838] bg-[#0b0810]">
      <div className="container mx-auto px-6 sm:px-12 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/#about" className="text-[#8892A0] hover:text-primary-400 transition-colors duration-300">
                  About
                </Link>
              </li>
              <li>
                <Link href="/#services" className="text-[#8892A0] hover:text-primary-400 transition-colors duration-300">
                  Services
                </Link>
              </li>
              {/* <li>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-[#1a1624] border border-[#2f2838] flex items-center justify-center text-[#8892A0] hover:border-primary-500/50 hover:text-primary-400 transition-all duration-300"
              >
        ...
        <div className="border-t border-[#2f2838] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
