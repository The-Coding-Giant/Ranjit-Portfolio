...
const Footer = () => {
  return (
    <footer className="border-t border-[#33353F] bg-[#0a0a0a]">
      <div className="container mx-auto px-6 sm:px-12 py-12">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-[#181818] border border-[#33353F] flex items-center justify-center text-[#8892A0] hover:border-primary-500/50 hover:text-primary-400 transition-all duration-300"
              >
        ...
        <div className="border-t border-[#33353F] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
