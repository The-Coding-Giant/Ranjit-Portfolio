        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-[#8892A0] max-w-sm leading-relaxed">
              Aspiring software developer focused on data-driven insights, reliable
              code, and practical analytics.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-[#8892A0] hover:border-primary-500/50 hover:text-primary-400 transition-all duration-300"
              >
